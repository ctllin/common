 ...
 * 作�? 赵磊
 * 
 * JSON �?JavaScript Object Natation，它是一种轻量级的数据交换格�?除了字符 "，\�?
 * 和一些控制符（\b，\f，\n，\r，\t）需要编码外，其�?Unicode 字符可以直接输出 Object 对象�?JSON 中是�?{}
 * 包含�?��列无序的 Key-Value 键�?对表示的，实际上此处�?Object 相当�?Java 中的 Map<String, Object>，�?不是
 * Java �?Class 。注�?Key 只能�?String 表示�?
 * 
 * Prototype提供�?evalJSON() 方法，能直接将服务器返回�?JSON 文本变成�?�� JavaScript 变量
 * 
 * 
 */
