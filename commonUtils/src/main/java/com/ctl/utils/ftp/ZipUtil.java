...
public class ZipUtil {
	...
	public static void main(String[] args){
		String str="D:\\ftpclient\\GZ_2017-01-11015051_120.zip";
	   ...
	   // str="D:\\ftpclient\\bj.zip";
	    ...
	    unZip2(str,str,new UnZipResult(false),"11");
	}
	/**
     * 解压Zip文件
     * @param path 文件目录
    	...
    	// lock.lock();
         ...
         try
         {
             ...
             while(entries.hasMoreElements())
             {
                 ...
                 if(!(filename.endsWith(".zip")||parentPath.endsWith("portal_comments")||parentPath.endsWith("portal_orders")||parentPath.endsWith("portal_signImages"))){
                	 continue;
                 }
                 file = new File(filename);
                 if(!file.exists()){ //如果是目录先创建
